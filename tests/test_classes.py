import unittest
import ast
from reference_generator.classes import TopLevelFunction
...
class TestTopLevelFunction(unittest.TestCase):
    ...
    def test_docstring_template(self):
        base_function: TopLevelFunction = TopLevelFunction(open_read_parse('tests/test_files/functions/base_function.py'), 'functions')
        ...
        return_function: TopLevelFunction = TopLevelFunction(open_read_parse('tests/test_files/functions/return_function.py'), 'functions')
        ...
        parameter_function: TopLevelFunction = TopLevelFunction(open_read_parse('tests/test_files/functions/parameter_function.py'), 'functions')
        ...
        multiple_parameter_function: TopLevelFunction = TopLevelFunction(open_read_parse('tests/test_files/functions/multiple_parameter_function.py'), 'functions')
        ...
        full_function: TopLevelFunction = TopLevelFunction(open_read_parse('tests/test_files/functions/full_function.py'), 'functions')
